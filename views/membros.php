...
<table class="table table-striped">
    ...
    <?php
    //lista de membros
    $membros = $viewData['membros'];
    foreach ($membros as $key => $membro) {
        # code...
        ?>
        <tr>
        <td ><input type="checkbox" name="selectMember" id="selectMember<?php echo($key); ?>" value="<?php echo($key); ?>"></td>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <h5 class="text-center pb-3">
                <span id="f-1" class="f">Ficha</span> <span class="n " id="n-1">1</span> <span id="f-2" class="f">Ficha</span> <span class="n" id="n-2">2</span> <span id="f-3" class="f">Ficha</span> <span class="n" id="n-3">3</span> 
            </h5>
                <form id="cad1Form">
